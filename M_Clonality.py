"""
Calculate clonality scores for paired, and alpha and beta datasets and
compare how clonality scores differ when looking only at single chain
as opposed to paired alpha/beta sequences.
...
plt.tight_layout()
plt.savefig('clonality_pairedvsingle.svg',format='svg')
