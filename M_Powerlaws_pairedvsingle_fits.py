...
xmin=1 # change this if you want. Best results at xmin=1 for our simulations.
xmax=np.infty # change this if you want.
...
plt.figure()
#paired
xpmaxP=((Z(exponent_p_all,xmin,xmax)/len(TRp_all))**(-1/exponent_p_all))*2
...
#alpha
xpmaxA=((Z(exponent_a_all,xmin,xmax)/len(TRp_all))**(-1/exponent_a_all))*2
...
#beta
xpmaxB=((Z(exponent_b_all,xmin,xmax)/len(TRp_all))**(-1/exponent_b_all))*2
