...
plt.xscale('log')
plt.yscale('log')
plt.xlabel('clone size',fontsize=20)
plt.ylabel('frequency',fontsize=20)
plt.xlim([10**0-0.2,10**3])
plt.ylim([10**-6,10**0+1])
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('CD4_fitted_powerlaws_paper.svg',format='svg')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('CD8_fitted_powerlaws_paper.svg',format='svg')
...
plt.xlabel('Xmin',fontsize=20)
plt.ylabel('exponent',fontsize=20)
plt.ylim(1,6)
plt.xlim(0.5,5.5)
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('mean_powerlaw_exponents.svg',format='svg')
...
for i in range(5):
    ...
    plt.savefig(('S'+str(i+1)+'_powerlaw_exponents.svg'),format='svg')
...
plt.tight_layout()
plt.savefig('S1_CD4vCD8_powerlaw_paper.svg',format='svg')
...
plt.legend(fontsize=12)
plt.tight_layout()
plt.savefig('S2_CD4vCD8_powerlaw_paper.svg',format='svg')
...
plt.legend(fontsize=12)
plt.tight_layout()
plt.savefig('S3_CD4vCD8_powerlaw_paper.svg',format='svg')
...
plt.legend(fontsize=12)
plt.tight_layout()
plt.savefig('S4_CD4vCD8_powerlaw_paper.svg',format='svg')
...
plt.legend(fontsize=12)
plt.tight_layout()
plt.savefig('S5_CD4vCD8_powerlaw_paper.svg',format='svg')
