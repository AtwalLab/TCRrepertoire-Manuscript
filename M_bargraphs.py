"""
This code calculates frequences of gene usage (V and J),and plot bargraphs per each gene,
per CD type, per productive/unproductive sequences.
...
def bargraph(ar1,ar2,ar3,ar4,ar5, gene_list, xlabel='', ylabel='',fig_title=''):
    ...
    plt.xticks(np.array(tick_pos), gene_list, rotation=90, size=8)
