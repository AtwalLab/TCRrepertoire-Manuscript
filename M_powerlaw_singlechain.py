...
plt.tight_layout()
plt.savefig('alpha_CD4_powerlaws_paper.svg',format='svg')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('beta_CD4_powerlaws_paper.svg',format='svg')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('alpha_CD8_powerlaws_paper.svg',format='svg')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('beta_CD8_powerlaws_paper.svg',format='svg')
